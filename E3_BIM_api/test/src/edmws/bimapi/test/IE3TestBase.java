...
//	 test data parameters	
	...
	/**
	 * Default DEV_ROOT - useful but still not 100% safe...
	 */
	public abstract String getDevRootFolder();
	public abstract void setDevRootFolder(String folder); 
	
	/**
	 * Default input path for test data files. These files are shared for several samples.
	 */
	public abstract String getInputRootFolder();
	public abstract String getInputPathIfc2x3();
