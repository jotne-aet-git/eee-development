...
//	for local context mode 
	public String getDatabaseFolder() {return getInputRootFolder() + "db_e3/";}
...
//	 test data parameters	
	...
	{
		File tmp = new File(this.getInputRootFolder());
		...
		if(m_remoteContext == null) {
	   		...
	   		if("LOCAL_DB".equalsIgnoreCase(commType)) {
	   			...
	   			if(!server.isDatabaseOpen()) {
	   				EDMDatabase db = server.getDatabase(this.getDatabaseFolder(),dbName,dbPass);
